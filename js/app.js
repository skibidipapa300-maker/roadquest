const API_URL = 'https://roadquest.others.ccs4thyear.com/api';
...
function loadCars(featured = false, params = {}) {
    ...
    axios.get(url)
        ...
        .catch(error => {
            console.error(error);
            if (featured) {
                $('#featured-cars').html('<div class="col-12 text-center text-danger"><p>Failed to load cars. Is the backend running?</p></div>');
                $('#featured-cars-carousel .carousel-inner').html('<div class="carousel-item active"><div class="text-center p-4 text-danger"><p>Failed to load cars. Is the backend running?</p></div></div>');
            } else {
                $('#cars-list').html('<div class="col-12 text-center text-danger"><p>Failed to load cars. Is the backend running?</p></div>');
            }
        });
}
...
function loadPopularCars() {
    axios.get(`${API_URL}/cars/popular?limit=3`)
        ...
        .catch(error => {
            console.error(error);
            $('#popular-cars').html('<div class="col-12 text-center text-danger"><p>Failed to load popular cars.</p></div>');
            $('#popular-cars-carousel .carousel-inner').html('<div class="carousel-item active"><div class="text-center p-4 text-danger"><p>Failed to load popular cars.</p></div></div>');
        });
}
