...
function loadDashboardStats() {
    ...
    axios.get(`${API_URL}/rentals`) 
        .then(res => $('#total-rentals').text(res.data.length))
    ...
    axios.get(url)
        .then(response => {
            ...
            if (filteredRentals.length === 0) {
                tbody.append('<tr><td colspan="8" class="text-center">No history available.</td></tr>');
            ...
            filteredRentals.forEach(rental => {
                ...
                const processedBy = rental.processed_by_user ? rental.processed_by_user.full_name : (rental.processed_by || 'System/User');
                ...
                cardsContainer.append(`
                    <div class="card mb-3 shadow-sm">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <strong>Processed By:</strong> ${processedBy}
                            </div>
                            <div class="d-grid">
                                <button class="btn btn-sm btn-danger" onclick="deleteRental(${rental.rental_id})">Delete</button>
                            </div>
        ...
        .catch(err => {
            console.error(err);
            $('#admin-history-table tbody').html('<tr><td colspan="8" class="text-center text-danger">Failed to load history.</td></tr>');
